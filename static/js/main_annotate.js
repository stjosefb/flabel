    ...
    $.ajax({
      ...
      success: function(resp){
          ...
          for (var j = 0, len = lines.length; j < len; j++) {
            ...
            imgArray[j] = 'http://localhost:9000/static/data/' + lines[j];
            gtArray[j] = 'http://localhost:9000/static/data/' + linesGT[j];
            bbArray[j] = 'http://localhost:9000/static/data/' + linesBB[j];
